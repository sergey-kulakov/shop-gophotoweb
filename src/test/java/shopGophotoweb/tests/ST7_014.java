...
public class ST7_014 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
       ...
       product1Page.goToCatalogByBreadecrumbs();
        ...
        logger.info("Expected result: total price = 4 353.10 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"4 353.10 pуб.");
     ...
     Utilites.goToSidebarItem(Utilites.SidebarItems.Заказы);
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"4 353.10 pуб.");
    }
}
