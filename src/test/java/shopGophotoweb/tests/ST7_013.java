...
public class ST7_013 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
        ...
        logger.info("Expected result: total price = 4 368.25 p.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"4 368.25 p.");
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"4 368.25 p.");
    }
}
